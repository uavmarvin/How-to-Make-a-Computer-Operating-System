...
In the IO class ([io.cc](../src/kernel/arch/x86/io.cc)),:
...
We add a method **putc** to the [IO Class](../src/kernel/arch/x86/io.cc) to put a character on the screen and update the (x,y) position.
...
We also add a useful and very known method: [printf](../src/kernel/arch/x86/io.cc#L155)
